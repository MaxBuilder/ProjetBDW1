...
abstract class DAO {
    ...
    // Retourne un tableau 1D avec les données d'un seul enregistrement ou false
    ...
    // Retourne un tableau 2D avec éventuellement plusieurs enregistrements ou false
